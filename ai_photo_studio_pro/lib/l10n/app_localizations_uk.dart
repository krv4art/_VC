...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get welcomeMessage => 'Ласкаво просимо';
  ...
  @override
  String get myPhotos => 'Мої фотографії';

  @override
  String get stylesCatalog => 'Каталог стилів';

  @override
  String get unlockPremium => 'Розблокувати Преміум';
  ...
  @override
  String get allStyles => 'Всі стилі';

  @override
  String get categoryProfessional => 'Професійний';

  @override
  String get categoryCasual => 'Повсякденний';

  @override
  String get categoryCreative => 'Творчий';

  @override
  String get categoryFormal => 'Офіційний';

  @override
  String get categoryOutdoor => 'На вулиці';

  @override
  String get categoryStudio => 'Студійний';

  @override
  String get sortNewest => 'Спочатку нові';

  @override
  String get sortOldest => 'Спочатку старі';

  @override
  String get sharePhoto => 'Поділитися фото';

  @override
  String get downloadHD => 'Завантажити в HD';

  @override
  String get deletePhoto => 'Видалити фото';

  @override
  String get deleteConfirm => 'Ви впевнені, що хочете видалити це фото?';

  @override
  String get photoDeleted => 'Фото видалено';

  @override
  String get premiumOnly => 'Тільки для преміум';
  ...
  @override
  String get language_nl => 'Голландська';
  ...
  String get selectIngredientsAllergicSensitive =>
      'Оберіть інгредієнти, на які у вас підвищена чутливість';
  ...
  String get errorSupabaseClientNotInitialized =>
      'Помилка: клієнт Supabase не ініціалізовано.';
  ...
  String get networkErrorOccurred =>
      'Сталася помилка мережі. Будь ласка, спробуйте пізніше.';
  ...
  String get hiIAmYourAIAssistantHowCanIHelp =>
      'Привіт! Я ваш ШІ-помічник. Чим можу вам допомогти?';

  @override
  String
  get iCanSeeYourScanResultsFeelFreeToAskMeAnyQuestionsAboutTheIngredientsSafetyConcernsOrRecommendations =>
      'Я бачу ваші результати сканування! Не соромтеся задавати мені будь-які запитання про інгредієнти, питання безпеки або рекомендації.';
  ...
  String get tablesInYourSupabaseDatabase =>
      'Таблиці у вашій базі даних Supabase:';
  ...
  String get failedToFetchSampleDataFor =>
      'Не вдалося отримати приклад даних для';
  ...
  String get clearAllDataConfirmation =>
      'Ви впевнені, що хочете видалити всі ваші локальні дані? Цю дію не можна скасувати.';
  ...
  String get deleteScanConfirmation =>
      'Ви впевнені, що хочете видалити це сканування з вашої історії?';
  ...
  String get deleteChatConfirmation =>
      'Ви впевнені, що хочете видалити цей чат? Усі повідомлення буде втрачено.';
  ...
  String get noCamerasFoundOnThisDevice =>
      'На цьому пристрої не знайдено камер.';
  ...
  String get positionTheLabelWithinTheFrame =>
      'Наведіть камеру на список інгредієнтів';
  ...
  String get sensitiveSkinDescription =>
      'Легко подразнюється, схильна до почервоніння';
  ...
  String get unlockExclusiveFeatures =>
      'Розблокуйте ексклюзивні функції, щоб отримати максимум від аналізу вашої шкіри.';

  @override
  String get unlimitedProductScans =>
      'Необмежена кількість сканувань продуктів';

  @override
  String get advancedAIIngredientAnalysis =>
      'Розширений ШІ-аналіз інгредієнтів';
  ...
  String get wereSorryYouDidntHaveAGreatExperience =>
      'Нам шкода, що ви залишилися незадоволені. Будь ласка, повідомте нам, що пішло не так.';
  ...
  String get aiDisclaimer =>
      'Відповіді ШІ можуть містити неточності. Будь ласка, перевіряйте критичну інформацію.';
  ...
  String get naturalThemeDescription =>
      'Природна тема з екологічними кольорами';
  ...
  String get resetSettingsConfirmation =>
      'Ви впевнені, що хочете скинути всі налаштування до стандартних значень?';
  ...
  String get customPromptDescription =>
      'Додайте персоналізовані інструкції для ШІ-асистента';
  ...
  String get scanLimitReachedMessage =>
      'Ви використали всі 5 безкоштовних сканувань на цьому тижні. Оформіть підписку Premium для необмеженої кількості сканувань!';
  ...
  String get historyLimitReachedMessage =>
      'Оформіть підписку Premium для доступу до повної історії сканувань!';
  ...
  String get slowInternetMessage =>
      'На дуже повільному інтернеті доведеться трохи зачекати... Ми все ще аналізуємо ваше зображення.';
  ...
  String get paywallTitle =>
      'Розкрийте секрети вашої косметики за допомогою ШІ';
  ...
  String get botGreeting3 =>
      'Привітую вас! Готовий допомогти з аналізом косметики.';
  ...
  String get botGreeting5 =>
      'Ласкаво просимо! Давайте разом вивчимо склад вашої косметики.';

  @override
  String get botGreeting6 =>
      'Вітаю! Готовий відповісти на ваші запитання про косметику.';

  @override
  String get botGreeting7 =>
      'Привіт! Я ваш персональний помічник з косметології.';

  @override
  String get botGreeting8 =>
      'Добрий день! Допоможу розібратися зі складом косметичних засобів.';

  @override
  String get botGreeting9 =>
      'Вітаю! Давайте зробимо вашу косметику безпечнішою.';

  @override
  String get botGreeting10 =>
      'Привітую! Готовий поділитися знаннями про косметику.';

  @override
  String get botGreeting11 =>
      'Добрий день! Допоможу знайти найкращі косметичні рішення для вас.';

  @override
  String get botGreeting12 =>
      'Вітаю! Ваш експерт з безпеки косметики до ваших послуг.';

  @override
  String get botGreeting13 =>
      'Привіт! Давайте разом підберемо ідеальну косметику для вас.';

  @override
  String get botGreeting14 =>
      'Ласкаво просимо! Готовий допомогти з аналізом інгредієнтів.';

  @override
  String get botGreeting15 =>
      'Вітаю! Допоможу зрозуміти склад вашої косметики.';

  @override
  String get botGreeting16 =>
      'Привітую! Ваш гід у світі косметології готовий допомогти.';
  ...
  String get openSettingsAndGrantAccess =>
      'Відкрийте Налаштування і надайте доступ до камери';
  ...
  String get errorServiceOverloaded =>
      'Сервіс тимчасово перевантажений. Спробуйте через кілька секунд.';

  @override
  String get errorRateLimitExceeded =>
      'Занадто багато запитів. Зачекайте трохи і спробуйте знову.';

  @override
  String get errorTimeout =>
      'Перевищено час очікування. Перевірте підключення до інтернету і спробуйте знову.';
  ...
  String get errorAuthentication =>
      'Помилка автентифікації. Будь ласка, перезапустіть застосунок.';

  @override
  String get errorInvalidResponse =>
      'Отримано некоректну відповідь. Спробуйте знову.';
  ...
  String get onboardingGreeting =>
      'Ласкаво просимо! Щоб поліпшити якість відповідей, налаштуйте ваш профіль';
  ...
  String get customThemeInDevelopment =>
      'Функція кастомних тем знаходиться в розробці';

  @override
  String get customThemeComingSoon =>
      'Скоро буде доступно в майбутніх оновленнях';
  ...
  String get dailyMessageLimitReachedMessage =>
      'Ви надіслали 5 повідомлень сьогодні. Оформіть підписку Premium для необмеженого чату!';

  @override
  String get upgradeToPremiumForUnlimitedChat =>
      'Оформити Premium для необмеженого чату';
  ...
  String get darkOceanThemeDescription =>
      'Темна океанічна тема з блакитними акцентами';

  @override
  String get darkForestThemeDescription =>
      'Темна лісова тема з лаймовими акцентами';

  @override
  String get darkSunsetThemeDescription =>
      'Темна тема заходу з помаранчевими акцентами';

  @override
  String get darkVibrantThemeDescription =>
      'Темна яскрава тема з рожевими та фіолетовими акцентами';
  ...
  String get requestFeatureDescription =>
      'Потрібна особлива функція? Зв\'яжіться із нами для обговорення індивідуальної розробки під ваші бізнес-потреби.';
