...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get myPhotos => 'Мои фотографии';

  @override
  String get stylesCatalog => 'Каталог стилей';
  ...
  @override
  String get categoryProfessional => 'Профессиональный';

  @override
  String get categoryCasual => 'Повседневный';

  @override
  String get categoryCreative => 'Творческий';

  @override
  String get categoryFormal => 'Официальный';

  @override
  String get categoryOutdoor => 'На улице';

  @override
  String get categoryStudio => 'Студийный';
  ...
  @override
  String get downloadHD => 'Скачать в HD';

  @override
  String get deletePhoto => 'Удалить фото';

  @override
  String get deleteConfirm => 'Вы уверены, что хотите удалить это фото?';

  @override
  String get photoDeleted => 'Фото удалено';

  @override
  String get premiumOnly => 'Только для премиум';
  ...
  @override
  String get language_nl => 'Голландский';
  ...
  String get selectIngredientsAllergicSensitive =>
      'Выберите ингредиенты, на которые у вас повышенная чувствительность';
  ...
  String get errorSupabaseClientNotInitialized =>
      'Ошибка: Клиент Supabase не инициализирован.';
  ...
  String get hiIAmYourAIAssistantHowCanIHelp =>
      'Привет! Я ваш помощник ИИ. Чем я могу вам помочь?';

  @override
  String
  get iCanSeeYourScanResultsFeelFreeToAskMeAnyQuestionsAboutTheIngredientsSafetyConcernsOrRecommendations =>
      'Я вижу ваши результаты сканирования! Не стесняйтесь задавать мне любые вопросы о ингредиентах, проблемах безопасности или рекомендациях.';
  ...
  String get tablesInYourSupabaseDatabase =>
      'Таблицы в вашей базе данных Supabase:';
  ...
  String get failedToFetchSampleDataFor =>
      'Не удалось получить пример данных для';

  @override
  String get sampleData => 'Пример данных:';

  @override
  String get aiChats => 'Чаты ИИ';
  ...
  String get clearAllDataConfirmation =>
      'Вы уверены, что хотите удалить все ваши локальные данные? Это действие нельзя отменить.';
  ...
  String get deleteScanConfirmation =>
      'Вы уверены, что хотите удалить это сканирование из вашей истории?';
  ...
  String get noCamerasFoundOnThisDevice =>
      'На этом устройстве не найдено камер.';
  ...
  String get normalSkinDescription =>
      'Сбалансированная, не слишком жирная и не сухая';
  ...
  String get oilySkinDescription =>
      'Блестящая, большие поры, склонность к акне';
  ...
  String get sensitiveSkinDescription =>
      'Легко раздражается, склонна к покраснению';
  ...
  String get unlockExclusiveFeatures =>
      'Разблокируйте эксклюзивные функции, чтобы получить максимум от анализа вашей кожи.';

  @override
  String get unlimitedProductScans =>
      'Неограниченное количество сканирований продуктов';

  @override
  String get advancedAIIngredientAnalysis =>
      'Расширенный ИИ-анализ ингредиентов';
  ...
  String get wereSorryYouDidntHaveAGreatExperience =>
      'Нам жаль, что вы остались недовольны. Пожалуйста, сообщите нам, что пошло не так.';
  ...
  String get aiDisclaimer =>
      'Ответы ИИ могут содержать неточности. Пожалуйста, проверяйте критическую информацию.';
  ...
  String get naturalThemeDescription =>
      'Натуральная тема с экологичными цветами';
  ...
  String get customPromptDescription =>
      'Добавьте персонализированные инструкции для AI-ассистента';
  ...
  String get scanLimitReachedMessage =>
      'Вы использовали все 5 бесплатных сканирований на этой неделе. Оформите подписку Premium для неограниченного количества сканирований!';
  ...
  String get messageLimitReachedMessage =>
      'Вы отправили 5 сообщений сегодня. Оформите подписку Premium для неограниченного чата!';
  ...
  String get historyLimitReachedMessage =>
      'Оформите подписку Premium для доступа к полной истории сканирований!';
  ...
  String get upgradeToPremiumDescription =>
      'Получите неограниченные сканирования, сообщения и полный доступ к истории сканирований с Premium!';
  ...
  String get scanHistoryLimit =>
      'Только самое последнее сканирование видно в истории';

  @override
  String get upgradeForUnlimitedScans =>
      'Оформите Premium для неограниченных сканирований!';

  @override
  String get upgradeForUnlimitedChat =>
      'Оформите Premium для неограниченного чата!';
  ...
  String get slowInternetMessage =>
      'На очень медленном интернете придется немного подождать... Мы все еще анализируем ваше изображение.';
  ...
  String get botGreeting3 =>
      'Приветствую вас! Готов помочь с анализом косметики.';
  ...
  String get botGreeting5 =>
      'Добро пожаловать! Давайте вместе изучим состав вашей косметики.';

  @override
  String get botGreeting6 =>
      'Здравствуйте! Готов ответить на ваши вопросы о косметике.';

  @override
  String get botGreeting7 =>
      'Привет! Я ваш персональный помощник по косметологии.';

  @override
  String get botGreeting8 =>
      'Добрый день! Помогу разобраться в составе косметических средств.';

  @override
  String get botGreeting9 =>
      'Здравствуйте! Давайте сделаем вашу косметику безопаснее.';

  @override
  String get botGreeting10 =>
      'Приветствую! Готов поделиться знаниями о косметике.';

  @override
  String get botGreeting11 =>
      'Добрый день! Помогу найти лучшие косметические решения для вас.';

  @override
  String get botGreeting12 =>
      'Здравствуйте! Ваш эксперт по безопасности косметики к вашим услугам.';

  @override
  String get botGreeting13 =>
      'Привет! Давайте вместе подберем идеальную косметику для вас.';

  @override
  String get botGreeting14 =>
      'Добро пожаловать! Готов помочь с анализом ингредиентов.';

  @override
  String get botGreeting15 =>
      'Здравствуйте! Помогу понять состав вашей косметики.';

  @override
  String get botGreeting16 =>
      'Приветствую! Ваш гид в мире косметологии готов помочь.';
  ...
  String get openSettingsAndGrantAccess =>
      'Откройте Настройки и предоставьте доступ к камере';
  ...
  String get errorAuthentication =>
      'Ошибка аутентификации. Пожалуйста, перезапустите приложение.';

  @override
  String get errorInvalidResponse =>
      'Получен некорректный ответ. Попробуйте снова.';
  ...
  String get aiGenerationComingSoon =>
      'Генерация тем с AI будет в Iteration 5!';

  @override
  String get onboardingGreeting =>
      'Добро пожаловать! Чтобы улучшить качество ответов, давайте настроим ваш профиль';
  ...
  String get customThemeInDevelopment =>
      'Функция кастомных тем находится в разработке';

  @override
  String get customThemeComingSoon =>
      'Скоро будет доступно в следующих обновлениях';
  ...
  String get upgradeToPremiumForUnlimitedChat =>
      'Оформить Premium для неограниченного чата';
  ...
  String get darkOceanThemeDescription =>
      'Темная океанская тема с голубыми акцентами';

  @override
  String get darkForestThemeDescription =>
      'Темная лесная тема с салатовыми акцентами';

  @override
  String get darkSunsetThemeDescription =>
      'Темная тема заката с оранжевыми акцентами';

  @override
  String get darkVibrantThemeDescription =>
      'Темная яркая тема с розовыми и фиолетовыми акцентами';
  ...
  @override
  String get pollCardTitle => 'Чего не хватает в приложении?';

  @override
  String get pollCardSubtitle => 'Какие 3 функции нужно добавить в приложение?';
  ...
  String get requestFeatureDescription =>
      'Нужна особая функция? Свяжитесь с нами для обсуждения индивидуальной разработки под ваши бизнес-потребности.';
