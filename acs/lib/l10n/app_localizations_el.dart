...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get appName => 'AI Σαρωτής Καλλυντικών';
  ...
  @override
  String get aiChat => 'AI Σαρωτής Καλλυντικών';
  ...
  @override
  String get selectYourPreferredLanguage => 'Επιλέξτε την προτιμώμενη γλώσσα σας';
  ...
  @override
  String get language_ar => 'Αραβικά';

  @override
  String get language_ko => 'Κορεατικά';

  @override
  String get language_cs => 'Τσεχικά';

  @override
  String get language_da => 'Δανικά';

  @override
  String get language_el => 'Ελληνικά';

  @override
  String get language_fi => 'Φινλανδικά';

  @override
  String get language_hi => 'Χίντι';

  @override
  String get language_hu => 'Ουγγρικά';

  @override
  String get language_id => 'Ινδονησιακά';

  @override
  String get language_ja => 'Ιαπωνικά';

  @override
  String get language_nl => 'Ολλανδικά';

  @override
  String get language_no => 'Νορβηγικά';

  @override
  String get language_pl => 'Πολωνικά';

  @override
  String get language_pt => 'Πορτογαλικά';

  @override
  String get language_ro => 'Ρουμανικά';

  @override
  String get language_sv => 'Σουηδικά';

  @override
  String get language_th => 'Ταϊλανδικά';

  @override
  String get language_tr => 'Τουρκικά';

  @override
  String get language_vi => 'Βιετναμέζικα';

  @override
  String get language_zh => 'Κινεζικά';

  @override
  String get selectIngredientsAllergicSensitive => 'Επιλέξτε συστατικά στα οποία είστε ευαίσθητοι';

  @override
  String get commonAllergens => 'Συνηθισμένα Αλλεργιογόνα';
  ...
  @override
  String get sulfates => 'Θειικά Άλατα';
  ...
  @override
  String get personalizedWarnings => 'Προσωποποιημένες Προειδοποιήσεις';
  ...
  @override
  String get aiChatTitle => 'AI Σαρωτής Καλλυντικών';
  ...
  @override
  String get networkErrorOccurred => 'Παρουσιάστηκε σφάλμα δικτύου. Παρακαλώ δοκιμάστε ξανά αργότερα.';

  @override
  String get sorryAnErrorOccurred => 'Λυπούμαστε, προέκυψε σφάλμα. Παρακαλώ δοκιμάστε ξανά.';
  ...
  @override
  String get hiIAmYourAIAssistantHowCanIHelp => 'Γεια σας! Είμαι ο AI βοηθός σας. Πώς μπορώ να βοηθήσω;';

  @override
  String get iCanSeeYourScanResultsFeelFreeToAskMeAnyQuestionsAboutTheIngredientsSafetyConcernsOrRecommendations => 'Μπορώ να δω τα αποτελέσματα σάρωσής σας! Μη διστάσετε να με ρωτήσετε οτιδήποτε για συστατικά, ασφάλεια ή συστάσεις.';
  ...
  @override
  String get viewSampleData => 'Προβολή Δείγματος Δεδομένων';

  @override
  String get failedToFetchSampleDataFor => 'Αποτυχία ανάκτησης δείγματος δεδομένων για';

  @override
  String get sampleData => 'Δείγμα Δεδομένων:';

  @override
  String get aiChats => 'AI Σαρωτές Καλλυντικών';

  @override
  String get noDialoguesYet => 'Δεν υπάρχουν συνομιλίες ακόμα.';
  ...
  @override
  String get clearAllDataConfirmation => 'Είστε σίγουροι ότι θέλετε να διαγράψετε όλα τα τοπικά σας δεδομένα; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';
  ...
  @override
  String get deleteScanConfirmation => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή τη σάρωση από το ιστορικό σας;';

  @override
  String get deleteChat => 'Διαγραφή Συνομιλίας';

  @override
  String get deleteChatConfirmation => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή τη συνομιλία; Όλα τα μηνύματα θα χαθούν.';
  ...
  @override
  String get analyzingPleaseWait => 'Ανάλυση σε εξέλιξη, παρακαλώ περιμένετε...';
  ...
  @override
  String get normalSkinDescription => 'Ισορροπημένο, ούτε λιπαρό ούτε ξηρό';

  @override
  String get dry => 'Ξηρό';

  @override
  String get drySkinDescription => 'Τεντωμένο, αποφλοιωμένο, τραχιά υφή';

  @override
  String get oily => 'Λιπαρό';

  @override
  String get oilySkinDescription => 'Γυαλιστερό, μεγάλοι πόροι, ευαίσθητο σε ακμή';
  ...
  @override
  String get sensitiveSkinDescription => 'Εύκολα ερεθισμένο, ευαίσθητο σε ερυθρότητα';
  ...
  @override
  String get goPremium => 'Αναβάθμιση σε Premium';
  ...
  @override
  String get advancedAIIngredientAnalysis => 'Προηγμένη AI Ανάλυση Συστατικών';

  @override
  String get fullScanAndSearchHistory => 'Πλήρες Ιστορικό Σαρώσεων';

  @override
  String get adFreeExperience => '100% Χωρίς Διαφημίσεις';
  ...
  String savePercentage(int percentage) {
    return 'Εξοικονομήστε $percentage%';
  }
  ...
  @override
  String get startFreeTrial => 'Ξεκινήστε Δωρεάν Δοκιμή';

  @override
  String trialDescription(String planName) {
    return '7ήμερη δωρεάν δοκιμή, στη συνέχεια χρέωση $planName. Ακύρωση ανά πάσα στιγμή.';
  }
  ...
  @override
  String get bestRatingWeCanGet => 'Η καλύτερη αξιολόγηση που μπορούμε να λάβουμε';
  ...
  @override
  String get whatCanBeImproved => 'Τι θα μπορούσε να βελτιωθεί;';

  @override
  String get wereSorryYouDidntHaveAGreatExperience => 'Λυπούμαστε που δεν είχατε καλή εμπειρία. Παρακαλώ πείτε μας τι πήγε στραβά.';
  ...
  @override
  String get discussWithAI => 'Συζήτηση με AI';

  @override
  String get enterYourEmail => 'Εισαγάγετε το email σας';

  @override
  String get enterYourPassword => 'Εισαγάγετε τον κωδικό σας';

  @override
  String get aiDisclaimer => 'Οι απαντήσεις AI μπορεί να περιέχουν ανακρίβειες. Παρακαλώ επαληθεύστε τις κρίσιμες πληροφορίες.';
  ...
  @override
  String get ageRange36_45Description => 'Αντιγηραντική φροντίδα';
  ...
  @override
  String get personalAIConsultant => 'Προσωπικός AI Σύμβουλος 24/7';
  ...
  @override
  String get selectPreferredTheme => 'Επιλέξτε το προτιμώμενο θέμα σας';
  ...
  @override
  String get darkThemeDescription => 'Σκούρο θέμα για άνεση των ματιών';

  @override
  String get oceanThemeDescription => 'Δροσερό ωκεάνιο θέμα';

  @override
  String get forestThemeDescription => 'Φυσικό δασικό θέμα';
  ...
  @override
  String get enterBotName => 'Εισαγάγετε όνομα bot';

  @override
  String get pleaseEnterBotName => 'Παρακαλώ εισαγάγετε όνομα bot';
  ...
  String defaultBotDescription(String name) {
    return 'Γεια σας! Είμαι η $name (συντομογραφία του AI Cosmetic Scanner). Θα σας βοηθήσω να κατανοήσετε τη σύνθεση των καλλυντικών σας. Έχω τεράστιες γνώσεις στην καλλυντολογία και τη φροντίδα. Θα χαρώ να απαντήσω σε όλες τις ερωτήσεις σας.';
  }
  ...
  @override
  String get resetSettingsConfirmation => 'Είστε σίγουροι ότι θέλετε να επαναφέρετε όλες τις ρυθμίσεις στις προεπιλεγμένες τιμές;';
  ...
  @override
  String get unsavedChangesMessage => 'Έχετε μη αποθηκευμένες αλλαγές. Είστε σίγουροι ότι θέλετε να φύγετε;';

  @override
  String get stay => 'Παραμονή';

  @override
  String get leave => 'Έξοδος';
  ...
  @override
  String get customPromptPlaceholder => 'Εισαγάγετε τα ειδικά σας αιτήματα...';

  @override
  String get enableCustomPrompt => 'Ενεργοποίηση ειδικών αιτημάτων';

  @override
  String get defaultCustomPrompt => 'Κάνε μου κομπλιμέντα.';
  ...
  @override
  String get scanLimitReached => 'Επιτεύχθηκε το Όριο Σαρώσεων';
  ...
  @override
  String get messageLimitReached => 'Επιτεύχθηκε το Ημερήσιο Όριο Μηνυμάτων';
  ...
  @override
  String get limitsReached => 'Όρια που επιτεύχθηκαν';

  @override
  String get remainingScans => 'Υπολειπόμενες σαρώσεις';

  @override
  String get remainingMessages => 'Υπολειπόμενα μηνύματα';
  ...
  @override
  String get premiumBenefits => 'Οφέλη Premium';

  @override
  String get unlimitedAiChatMessages => 'Απεριόριστα μηνύματα AI chat';

  @override
  String get fullAccessToScanHistory => 'Πλήρης πρόσβαση στο ιστορικό σαρώσεων';

  @override
  String get prioritySupport => 'Προτεραιότητα υποστήριξης';
  ...
  @override
  String get revolutionaryAIDesc => 'Μία από τις πιο έξυπνες στον κόσμο';

  @override
  String get unlimitedScans => 'Απεριόριστες Σαρώσεις';

  @override
  String get unlimitedScansDesc => 'Εξερευνήστε τα καλλυντικά χωρίς όρια';

  @override
  String get unlimitedChats => 'Απεριόριστες Συνομιλίες';

  @override
  String get unlimitedChatsDesc => 'Προσωπικός AI σύμβουλος 24/7';
  ...
  @override
  String get rememberContext => 'Απομνημόνευση Πλαισίου';

  @override
  String get rememberContextDesc => 'Η AI θυμάται τα προηγούμενα μηνύματά σας';

  @override
  String get allIngredientsInfo => 'Πληροφορίες για Όλα τα Συστατικά';
  ...
  @override
  String get noAdsDesc => 'Για όσους εκτιμούν τον χρόνο τους';
  ...
  @override
  String get botGreeting2 => 'Γεια σας! Τι σας φέρνει σε μένα;';

  @override
  String get botGreeting3 => 'Σας καλωσορίζω! Έτοιμος να βοηθήσω με την καλλυντική ανάλυση.';

  @override
  String get botGreeting4 => 'Χαίρομαι που σας βλέπω! Πώς μπορώ να είμαι χρήσιμος;';

  @override
  String get botGreeting5 => 'Καλώς ήρθατε! Ας εξερευνήσουμε μαζί τη σύνθεση των καλλυντικών σας.';

  @override
  String get botGreeting6 => 'Γεια σας! Έτοιμος να απαντήσω στις ερωτήσεις σας για τα καλλυντικά.';

  @override
  String get botGreeting7 => 'Γεια! Είμαι ο προσωπικός σας βοηθός καλλυντολογίας.';

  @override
  String get botGreeting8 => 'Καλημέρα! Θα σας βοηθήσω να κατανοήσετε τη σύνθεση των καλλυντικών προϊόντων.';

  @override
  String get botGreeting9 => 'Γεια σας! Ας κάνουμε τα καλλυντικά σας πιο ασφαλή μαζί.';

  @override
  String get botGreeting10 => 'Σας καλωσορίζω! Έτοιμος να μοιραστώ γνώσεις για τα καλλυντικά.';

  @override
  String get botGreeting11 => 'Καλημέρα! Θα σας βοηθήσω να βρείτε τις καλύτερες καλλυντικές λύσεις για εσάς.';

  @override
  String get botGreeting12 => 'Γεια σας! Ο ειδικός σας στην ασφάλεια καλλυντικών είναι στην υπηρεσία σας.';

  @override
  String get botGreeting13 => 'Γεια! Ας επιλέξουμε μαζί τα τέλεια καλλυντικά για εσάς.';

  @override
  String get botGreeting14 => 'Καλώς ήρθατε! Έτοιμος να βοηθήσω με την ανάλυση συστατικών.';

  @override
  String get botGreeting15 => 'Γεια σας! Θα σας βοηθήσω να κατανοήσετε τη σύνθεση των καλλυντικών σας.';

  @override
  String get botGreeting16 => 'Σας καλωσορίζω! Ο οδηγός σας στον κόσμο της καλλυντολογίας είναι έτοιμος να βοηθήσει.';
  ...
  @override
  String get errorServiceOverloaded => 'Η υπηρεσία είναι προσωρινά απασχολημένη. Παρακαλώ δοκιμάστε ξανά σε λίγο.';

  @override
  String get errorRateLimitExceeded => 'Πάρα πολλά αιτήματα. Παρακαλώ περιμένετε λίγο και δοκιμάστε ξανά.';

  @override
  String get errorTimeout => 'Λήξη χρονικού ορίου αιτήματος. Παρακαλώ ελέγξτε τη σύνδεσή σας στο internet και δοκιμάστε ξανά.';

  @override
  String get errorNetwork => 'Σφάλμα δικτύου. Παρακαλώ ελέγξτε τη σύνδεσή σας στο internet.';

  @override
  String get errorAuthentication => 'Σφάλμα ταυτοποίησης. Παρακαλώ επανεκκινήστε την εφαρμογή.';

  @override
  String get errorInvalidResponse => 'Ελήφθη μη έγκυρη απάντηση. Παρακαλώ δοκιμάστε ξανά.';

  @override
  String get errorServer => 'Σφάλμα διακομιστή. Παρακαλώ δοκιμάστε ξανά αργότερα.';
  ...
  String colorsResetTo(Object themeName) {
    return 'Τα χρώματα επαναφέρθηκαν σε $themeName';
  }

  @override
  String get aiGenerationComingSoon => 'Η δημιουργία θεμάτων με AI έρχεται στην Επανάληψη 5!';

  @override
  String get onboardingGreeting => 'Καλώς ήρθατε! Για να βελτιώσουμε την ποιότητα των απαντήσεων, ας ρυθμίσουμε το προφίλ σας';

  @override
  String get letsGo => 'Ας Ξεκινήσουμε';
  ...
  @override
  String get customThemeInDevelopment => 'Τα προσαρμοσμένα θέματα είναι υπό ανάπτυξη';

  @override
  String get customThemeComingSoon => 'Έρχεται σύντομα σε μελλοντικές ενημερώσεις';

  @override
  String get dailyMessageLimitReached => 'Επιτεύχθηκε το Όριο';
  ...
  @override
  String get messagesLeftToday => 'μηνύματα που απομένουν σήμερα';
  ...
  @override
  String get darkVibrant => 'Σκούρο Ζωηρό';

  @override
  String get darkOceanThemeDescription => 'Σκούρο ωκεάνιο θέμα με κυανές πινελιές';

  @override
  String get darkForestThemeDescription => 'Σκούρο δασικό θέμα με λαχανί πινελιές';

  @override
  String get darkSunsetThemeDescription => 'Σκούρο θέμα ηλιοβασιλέματος με πορτοκαλί πινελιές';

  @override
  String get darkVibrantThemeDescription => 'Σκούρο ζωηρό θέμα με ροζ και μωβ πινελιές';
  ...
  String deleteThemeConfirmation(String themeName) {
    return 'Είστε σίγουροι ότι θέλετε να διαγράψετε το \"$themeName\";';
  }
  ...
  @override
  String get pollDescription => 'Μπορείτε να ψηφίσετε έως 3 επιλογές';
  ...
  @override
  String get enterYourOption => 'Εισαγάγετε την επιλογή σας...';

  @override
  String get add => 'Προσθήκη';

  @override
  String get filterTopVoted => 'Δημοφιλή';

  @override
  String get filterNewest => 'Νέα';
  ...
  @override
  String get requestFeatureDevelopment => 'Αίτημα Ανάπτυξης Προσαρμοσμένης Λειτουργίας';

  @override
  String get requestFeatureDescription => 'Χρειάζεστε συγκεκριμένη λειτουργία; Επικοινωνήστε μαζί μας για να συζητήσουμε την προσαρμοσμένη ανάπτυξη για τις επιχειρηματικές σας ανάγκες.';

  @override
  String get pollHelpTitle => 'Πώς να ψηφίσετε';

  @override
  String get pollHelpDescription => '• Μπορείτε να ψηφίσετε έως 3 επιλογές\n• Πατήστε μια επιλογή για να την επιλέξετε\n• Πατήστε ξανά για να αποεπιλέξετε\n• Προσθέστε τη δική σας επιλογή αν δεν βλέπετε αυτό που χρειάζεστε\n• Οι ψήφοι σας αποθηκεύονται αυτόματα';
}
