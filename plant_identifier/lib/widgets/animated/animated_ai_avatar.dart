...
class _MolecularAvatarPainter extends CustomPainter {
  ...
  void _drawOuterNode(
    ...
    final primary = colors?.primary ?? const Color(0xFF4CAF50);
    final secondary = colors?.secondary ?? const Color(0xFF81C784);
  ...
  void _drawCenterNode(Canvas canvas, Offset center, double baseRadius) {
    ...
    final primary = colors?.primary ?? const Color(0xFF4CAF50);
    final primaryDark = colors?.primaryDark ?? const Color(0xFF2E7D32);
    final secondary = colors?.secondary ?? const Color(0xFF81C784);
