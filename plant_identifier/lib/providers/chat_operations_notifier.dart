...
class ChatOperationsNotifier extends ChangeNotifier {
  ...
  bool get isLoadingPlantResult => _state.isLoadingPlantResult;
  ...
  /// Set loading plant result state
  void setLoadingPlantResult(bool loading) {
    _state = _state.copyWith(isLoadingPlantResult: loading);
    notifyListeners();
  }
  ...
  void updateOperationState({
    ...
    _state = _state.copyWith(
      ...
      isLoadingPlantResult: isLoadingPlantResult,
  ...
  String toString() =>
      ...
      'plantLoading: $isLoadingPlantResult)';
}
