...
class AnimatedRatingStars extends StatefulWidget {
  ...
  const AnimatedRatingStars({
    ...
    this.inactiveColor = const Color(0xFFBDBDBD), // neutral gray default
    required this.onRatingChanged,
  });

  // Factory constructor for creating with theme-aware colors
  factory AnimatedRatingStars.withThemeColors({
    Key? key,
    required int rating,
    int starCount = 5,
    double size = 36.0,
