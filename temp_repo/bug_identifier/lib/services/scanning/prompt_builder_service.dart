...
class PromptBuilderService {
  ...
  /// Build insect analysis prompt with user profile and language
  String buildInsectAnalysisPrompt(String userProfilePrompt, String languageCode) {
    // Use insect identification prompt
    return InsectIdentificationPrompt.withVariables(
      languageCode: languageCode,
      userProfile: userProfilePrompt,
    );
  }

  /// Build analysis prompt with user profile and language (LEGACY - for cosmetics)
  ...
  String _getDefaultAnalysisPrompt(
    ...
    return '''
        ...
        3. Analyze each ingredient's safety level considering: user's age, skin type, and allergies.
        4. Provide personalized warnings based on user's age, allergies, and skin type.
