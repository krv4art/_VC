      ...
      body: SingleChildScrollView(
        ...
        child: StaggeredListAnimation(
          children: [
            ...
            // Uses and benefits
            if (result.usesAndBenefits != null) ...[
              Card(
                child: Padding(
                  padding: const EdgeInsets.all(AppTheme.space16),
                  child: Column(
            ...
            // Common pests
            if (result.careInfo?.commonPests != null) ...[
              Card(
                child: Padding(
                  padding: const EdgeInsets.all(AppTheme.space16),
                  child: Column(
            ...
            // Common diseases
            if (result.careInfo?.commonDiseases != null) ...[
              Card(
                child: Padding(
                  padding: const EdgeInsets.all(AppTheme.space16),
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: AppTheme.space12),
                      Text(
                        result.careInfo!.commonDiseases!,
                        style: AppTheme.body.copyWith(color: colors.onSurface),
                      ),
                    ],
                  ),
