...
class ChatMessagesNotifier extends ChangeNotifier {
  ...
  /// Set linked scan result
  void setLinkedScanResult(
    dynamic linkedScanResult,
    dynamic linkedAnalysisResult,
  ) {
    _state = _state.copyWith(
      linkedScanResult: linkedScanResult,
      linkedAnalysisResult: linkedAnalysisResult,
    );
    notifyListeners();
  }
  ...
  dynamic get linkedScanResult => _state.linkedScanResult;

  /// Get linked analysis result
  dynamic get linkedAnalysisResult => _state.linkedAnalysisResult;
