...
/// Natural тема (по умолчанию) - адаптирована для Bug Identifier
/// Цветовая палитра вдохновлена природой: листва, кора, земля
class NaturalColors extends AppColors {
  // === PRIMARY COLORS ===
  @override
  final Color primary = const Color(0xFF689F38); // Olive Green - цвет листвы

  @override
  final Color primaryLight = const Color(0xFF8BC34A); // Light Green

  @override
  final Color primaryPale = const Color(0xFFDCEDC8); // Pale Green

  @override
  final Color primaryDark = const Color(0xFF5D4037); // Dark Brown - кора дерева

  // === NEUTRAL COLORS ===
  @override
  final Color neutral = const Color(0xFFBCAAA4); // Warm Grey

  @override
  final Color background = const Color(0xFFF1F8E9); // Light Green Tint - светлая зелень

  @override
  final Color surface = Colors.white;

  @override
  final Color onBackground = const Color(0xFF33691E); // Dark Olive

  @override
  final Color onSurface = const Color(0xFF212121); // Dark Gray

  @override
  final Color success = const Color(0xFF66BB6A); // Success Green

  @override
  final Color warning = const Color(0xFFFF8A65); // Warm Orange

  @override
  final Color error = const Color(0xFFE53935); // Red

  @override
  final Color info = const Color(0xFF42A5F5); // Blue
