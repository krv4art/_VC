...
class UserState with ChangeNotifier {
  ...
  bool _allergiesConfigured = false;
  ...
  bool get allergiesConfigured => _allergiesConfigured;
  ...
  Future<void> _loadPreferences() async {
    ...
    _allergiesConfigured = prefs.getBool('allergiesConfigured') ?? false;
  ...
  Future<void> setAllergies(List<String> allergies) async {
    ...
    // Устанавливаем флаг конфигурации аллергий
    _allergiesConfigured = true;
    await prefs.setBool('allergiesConfigured', true);
    notifyListeners();
  }
  ...
  Future<void> clearAllData({bool preservePremium = false}) async {
    ...
    await prefs.remove('allergiesConfigured');
