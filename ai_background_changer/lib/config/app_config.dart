...
class AppConfig {
  ...
  int? _freeProcessingsPerWeek;
  int? _freeMessagesPerDay;
  int? _freeVisibleResults;
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _freeProcessingsPerWeek = getEnvInt('FREE_PROCESSINGS_PER_WEEK', defaultValue: 5);
      _freeMessagesPerDay = getEnvInt('FREE_MESSAGES_PER_DAY', defaultValue: 5);
      _freeVisibleResults = getEnvInt('FREE_VISIBLE_RESULTS', defaultValue: 3);
      ...
      _freeProcessingsPerWeek = 5;
      _freeMessagesPerDay = 5;
      _freeVisibleResults = 3;
      _isInitialized = true;
    }
  }
  ...
  /// Лимит обработок для бесплатных пользователей
  int get freeProcessingsPerWeek => _freeProcessingsPerWeek ?? 5;
  ...
  int get freeVisibleResults => _freeVisibleResults ?? 3;
