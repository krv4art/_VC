...
class AppTheme {
  ...
  /// Creates ThemeData based on provided colors and dark theme flag
  /// Used by ThemeProviderV2 to generate themes dynamically
  static ThemeData getThemeData(AppColors colors, bool isDark) {
    return ThemeData(
      ...
      // Text Theme
      textTheme: TextTheme(
        displayLarge: headingLarge.copyWith(color: colors.onBackground),
        displayMedium: headingMedium.copyWith(color: colors.onBackground),
        displaySmall: headingSmall.copyWith(color: colors.onBackground),
